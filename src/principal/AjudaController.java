...
public class AjudaController {
	...
	public AjudaController() {
		this.listaAjuda = new HashMap<Integer, Ajuda>();
	}
    ...
    public int pedirAjudaPresencial (String matrAluno, String matrTutor, String disciplina, String horario, String dia, String localInteresse){
    	...
    	this.listaAjuda.put(id, new AjudaPresencial(id,matrAluno, matrTutor, disciplina, horario, dia, localInteresse));
    	return id;
    }
    ...
    public String pegarTutor(int idAjuda){
    	return this.listaAjuda.get((Integer) idAjuda).getTutor();
    }
    public String getInfoAjuda(int idAjuda, String atributo){
    	return this.listaAjuda.get((Integer) idAjuda).getInfo(atributo);
    }
